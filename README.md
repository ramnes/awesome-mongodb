...
### Articles
 - [A Custom WordPress Dashboard with MongoDB Atlas, Microsoft Azure, & Serverless Functions](https://ahmadawais.com/wordpress-mongodb-atlas-microsoft-azure-serverless-functions/) - MongoDB WordPress + Azure FTW!
